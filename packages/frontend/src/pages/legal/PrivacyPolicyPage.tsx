...
export function PrivacyPolicyPage() {
  return (
    <LegalPage title="Privacy Policy" updated="June 22, 2026">
      <p>
        This Privacy Policy explains how Trello Clone ("we", "us", or "the
        Service") collects, uses, and protects information when you use our
        project and board management application. By using the Service you agree
      ...
      <Section heading="Information we collect">
        <ul className="list-disc space-y-2 pl-6">
          ...
          <li>
            ...
            address, browser type, and timestamps, used to operate and secure
            the Service.
          </li>
          <li>
      ...
      <Section heading="Google API services and limited use">
        <p>
          ...
          , including the Limited Use requirements. We only access Google Drive
          to upload and manage backups you initiate, and we never sell this data
      ...
      <Section heading="Data retention and security">
        <p>
          ...
          passwords, and access controls to protect your information. No method
      ...
      <Section heading="Your rights">
        <p>
          ...
          your settings, or by contacting us. You may also disconnect Google
          Drive at any time, which revokes our access to it.
        </p>
      </Section>
      ...
      <Section heading="Contact us">
        <p>
          ...
          <a className="text-indigo-600 hover:underline" href={`mailto:${CONTACT_EMAIL}`}>
            {CONTACT_EMAIL}
          </a>
          .
        </p>
