...
export function TermsOfServicePage() {
  return (
    <LegalPage title="Terms of Service" updated="June 22, 2026">
      <p>
        These Terms of Service ("Terms") govern your access to and use of Trello
        Clone ("the Service"). By creating an account or using the Service, you
      ...
      <Section heading="Your content">
        <p>
          ...
          create. You grant us a limited license to store and process that
          content solely to operate the Service for you. You are responsible for
      ...
      <Section heading="Availability and changes">
        <p>
          We provide the Service on an "as is" and "as available" basis and may
          modify, suspend, or discontinue features at any time. We may update
